...
input = np.random.rand(28)
layer1 = m.Layer(28, 3, neuron, 0.0625, Am, Ap, alfa_minus, alfa_plus)
#print(layer1.weights)
#layer2 = m.Layer(2, 1, neuron, 0.0625, Am, Ap, alfa_minus, alfa_plus)
snn = m.SNN([layer1], input, Lt, 3, range_t, rate=15)
in_spikes, out_spikes, out_rate, V = snn.inference()

print(f"rates of the output neurons: {out_rate}")
#print(snn.layers[0].weights)
utils.plot_spikes(28, 3, in_spikes, out_spikes, V, range_t)
plt.show()